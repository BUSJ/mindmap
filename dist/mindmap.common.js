...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MindMap_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("a66b");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MindMap_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MindMap_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MindMap_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("72c7");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("918fcb40", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./src/js/d3.js
...
// CONCATENATED MODULE: ./src/js/JSONData.js
...
var JSONData_JSONData = /*#__PURE__*/function () {
  function JSONData(d) {
  ...
  _createClass(JSONData, [{
    key: "_addId",
    value: function _addId() {
      var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      var d = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.data;

      // 添加唯一标识
      for (var index = 0; index < d.length; index += 1) {
        var dChild = d[index];
        dChild.id = "".concat(id).concat(index);

        if (dChild.children) {
          this._addId("".concat(id).concat(index), dChild.children);
        }
      }
    }
  }, {
    ...
    value: function getPuredata() {
      var d = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : JSON.parse(JSON.stringify(this.data));
    ...
    value: function add(dParent, d) {
      // dParent添加子节点d
      var parent = this._getItself(dParent);
      ...
      d.id = "".concat(parent.id).concat(parent.children.length);
      parent.children.push(d);

      this._addId("".concat(d.id), d.children);
    }
  }, {
    key: "_getParent",
    value: function _getParent(d) {
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.data;
      var dParent = data;
      var id = d.id.split('').map(function (s) {
        return parseInt(s, 10);
    ...
    value: function insert(dPosition, d) {
      ...
      var parent = this._getParent(dPosition);
...
/* harmony default export */ var js_JSONData = (JSONData_JSONData);
...
var History_History = /*#__PURE__*/function () {
  ...
  _createClass(History, [{
    ...
    value: function record(snapshot) {
      ...
      var snapshot1 = JSON.parse(JSON.stringify(snapshot)); // 深拷贝

      this.snapshots.push(snapshot1); // 确保历史记录条数限制
...
/* harmony default export */ var js_History = (History_History);
// CONCATENATED MODULE: ./src/js/toMarkdown.js



function toMarkdown_deepTraverse(d, m, md, flag) {
  for (var index = 0; index < d.length; index += 1) {
    var dChild = d[index];
    ...
    if (m.length > 3 && m[0] === '#') {
      ...
      md = toMarkdown_deepTraverse(dChild.children, "  -", md, '  ');
    } else {
      md += "".concat(m, " ").concat(dChild.name, "\n");
      md = toMarkdown_deepTraverse(dChild.children, "".concat(flag).concat(m), md, flag);
    }
  }
...
function toMarkdown(data) {
  return toMarkdown_deepTraverse(data, '#', '', '#');
}

/* harmony default export */ var js_toMarkdown = (toMarkdown);
...
/* harmony default export */ var MindMapvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    svgClass: function svgClass() {
      return "stroke-width-".concat(this.strokeWidth);
    },
    optionTip: function optionTip() {
  ...
  data: function data() {
    return {
      ...
      easePolyInOut: src_transition_transition().duration(1000).ease(polyInOut),
      link: linkHorizontal().x(function (d) {
        return d[0];
      }).y(function (d) {
        return d[1];
      }),
      zoom: d3_zoom_src_zoom(),
      history: new js_History(),
  ...
  watch: {
    ...
    showNodeAdd: function showNodeAdd(val) {
  ...
  methods: {
    init: function init() {
      ...
      // 绑定元素
      this.mindmap_svg = src_select(this.$refs.svg);
      this.mindmap_g = src_select(this.$refs.content).style('opacity', 0);
      this.dummy = src_select(this.$refs.dummy); // 绑定事件

      this.makeKeyboard(this.keyboard);
      this.mindmap_svg.on('contextmenu', function () {
        on_event.preventDefault();
      });
      this.mindmapSvgZoom = this.zoom.scaleExtent([0.1, 8]).on('zoom', function () {
        _this.mindmap_g.attr('transform', on_event.transform);
      });
      this.makeZoom(this.zoomable);
    },
    initNodeEvent: function initNodeEvent() {
      // 绑定节点事件
    ...
    // 事件
    makeKeyboard: function makeKeyboard(val) {
      this.mindmap_svg.on('keydown', val ? this.svgKeyDown : null);
    },
    makeNodeAdd: function makeNodeAdd(val) {
      var fObject = this.mindmap_g.selectAll('foreignObject');
      var gBtn = this.mindmap_g.selectAll('.gButton');
    ...
    makeContextMenu: function makeContextMenu(val) {
      this.mindmap_g.selectAll('foreignObject').on('contextmenu', val ? this.fObjectRightClick : null);
    },
    makeDrag: function makeDrag(val) {
      if (val) {
        var mindmap_g = this.mindmap_g,
            dragged = this.dragged,
            dragended = this.dragended;
        mindmap_g.selectAll('foreignObject').filter(function (d) {
          return d.depth !== 0;
        }) // 非根节点才可以拖拽
        .call(src_drag().container(function (d, i, n) {
          return n[i].parentNode.parentNode;
        }).on('drag', dragged).on('end', dragended));
      } else {
        this.mindmap_g.selectAll('foreignObject').call(src_drag().on('drag', null).on('end', null));
      }
    },
    makeNodeClick: function makeNodeClick(val) {
      this.mindmap_g.selectAll('foreignObject').on('click', val ? this.fObjectClick : null);
    },
    makeZoom: function makeZoom(val) {
      if (val) {
    ...
    undo: function undo() {
      if (this.canUndo) {
        this.toRecord = false;
        var prev = this.history.undo();
        this.mmdata = new js_JSONData(prev);
      }
    },
    redo: function redo() {
      if (this.canRedo) {
        ...
        this.mmdata = new js_JSONData(next);
      }
    },
    ...
    exportTo: function exportTo() {
      // 导出至
      var data = this.mmdata.getPuredata();
      var content = '';
    ...
    makeCenter: function makeCenter() {
      var _this2 = this;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return src_transition_transition().end().then(function () {
                  var div = _this2.$refs.mindmap;

                  var content = _this2.$refs.content.getBBox();

                  var _d3$zoomTransform = transform_transform(_this2.$refs.svg),
                      k = _d3$zoomTransform.k;

                  var x = -(div.offsetWidth - k * content.width) / (2 * k) - 5;

                  var y = -(div.offsetHeight - k * content.height) / (2 * k) - (-_this2.dTop.x - _this2.foreignY(_this2.dTop));

                  _this2.mindmap_svg.call(_this2.zoom.translateTo, x, y, [0, 0]);
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return src_transition_transition().end().then(function () {
                  var rect = _this3.$refs.content.getBBox();

                  var div = _this3.$refs.mindmap;
                  ...
                  _this3.mindmap_svg.transition(_this3.easePolyInOut).call(_this3.zoom.scaleTo, multiple);
                });
    ...
    // 数据操作
    add: function add(dParent, d) {
      this.toRecord = true;
      this.mmdata.add(dParent, d);
      this.depthTraverse2(this.mmdata.data, this.getTextSize);
    },
    insert: function insert(dPosition, d) {
      var i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      // 尝试优化动画效果
    ...
    del: function del(s) {
      ...
      (_this$selectedElement = this.selectedElement) === null || _this$selectedElement === void 0 ? void 0 : _this$selectedElement.remove(); // 使动画流畅

      this.toRecord = true;
      this.mmdata.del(s);
      this.depthTraverse2(this.mmdata.data, this.getTextSize);
    },
    updateName: function updateName(d, name) {
      var n = d.data.name;
    ...
    rightDrag: function rightDrag() {},
    rightDragEnd: function rightDragEnd() {},
    // 键盘
    svgKeyDown: function svgKeyDown() {
      ...
      var node = this.selectedElement;
      var seleData = this.selectedElement.__data__;
      var pNode = this.selectedElement.parentNode;
      var newJSON = {
        name: '新建节点',
        children: []
      };
    ...
    focusNode: function focusNode(fObj) {
      // 使节点处于可视区域
      var _d3$zoomTransform2 = transform_transform(this.$refs.svg),
          k = _d3$zoomTransform2.k; // 放大缩小倍数


      var fObjPos = fObj.node().getBoundingClientRect();
      var svgPos = this.mindmap_svg.node().getBoundingClientRect();
    ...
    editNew: function editNew(newJSON, depth, pNode) {
      var _this5 = this;
      ...
      src_transition_transition().end().then(function () {
        var node = src_select(pNode).selectAll("g.node.depth_".concat(depth)).filter(function (b) {
          return b.data === newJSON;
        }).node();

        _this5.editNode(node);
      }, function (err) {
        console.log(err);
      });
    },
    fdivMouseDown: function fdivMouseDown() {
    ...
    fObjectClick: function fObjectClick(d, i, n) {
      var _this6 = this;
      ...
      if (!edit) {
        ...
        var fObj = src_select(clickedNode).selectAll('foreignObject').filter(function (a, b, c) {
          return c[b].parentNode === clickedNode;
        });
        var fdiv = fObj.select('div').node();
        fdiv.contentEditable = true;
        new Promise(function (resolve) {
          setTimeout(function () {
            var flag = false; // 单击false 双击true

            if (document.activeElement !== fdiv) {
              fdiv.contentEditable = false;
            } else {
              flag = true; // this.removeSelectedNode()

              clickedNode.setAttribute('id', 'editing');

              _this6.focusNode(fObj);
            }
          ...
          if (!flag && clickedNode.isSameNode(sele)) {
            // 进入编辑状态
            _this6.editNode(clickedNode);
          }
        });
      }
    },
    fObjectRightClick: function fObjectRightClick(d, i, n) {
      var _this7 = this;
      ...
      var svgPos = this.mindmap_svg.node().getBoundingClientRect();
      this.contextMenuX = on_event.pageX - svgPos.left - window.pageXOffset;
      this.contextMenuY = on_event.pageY - svgPos.top - window.pageYOffset;
      this.showContextMenu = true;
      this.clearSelection();
      setTimeout(function () {
        _this7.$refs.menu.focus();
      }, 300);
    },
    gBtnClick: function gBtnClick(a, i, n) {
      // 添加子节点
    ...
    // 悬浮事件
    mouseLeave: function mouseLeave(d, i, n) {
    ...
    mouseEnter: function mouseEnter(d, i, n) {
      if (n[i].className.baseVal.includes('gButton')) {
    ...
    // 拖拽
    draggedNodeRenew: function draggedNodeRenew(draggedNode, targetX, targetY) {
      ...
      src_select(draggedNode).each(function (d) {
        src_select("path#path_".concat(d.data.id)).transition(tran).attr('d', "".concat(link({
          source: [-targetY + (d.parent ? d.parent.data.size[1] : 0) - xSpacing, -targetX + (d.parent ? d.parent.data.size[0] / 2 : 0)],
          target: [0, d.data.size[0] / 2]
        }), "L").concat(d.data.size[1] - xSpacing, ",").concat(d.data.size[0] / 2));
      });
    },
    draggedNodeChildrenRenew: function draggedNodeChildrenRenew(d, px, py) {
      var draggedNodeChildrenRenew = this.draggedNodeChildrenRenew;
      d.px = px;
      d.py = py;
    ...
    dragged: function dragged(a, i, n) {
      // 拖拽中【待完善】
      var draggedNodeChildrenRenew = this.draggedNodeChildrenRenew,
          draggedNodeRenew = this.draggedNodeRenew,
          mindmap_g = this.mindmap_g,
          xSpacing = this.xSpacing;
      ...
      var py = on_event.x - a.x; // x轴偏移的量

      var px = on_event.y - a.y; // y轴偏移的量

      draggedNodeChildrenRenew(a, px, py); // 相对a.parent位置的坐标

      var targetY = a.dy + py; // x轴坐标

      var targetX = a.dx + px; // y轴坐标

      draggedNodeRenew(draggedNode, targetX, targetY); // foreignObject偏移

      targetY += parseInt(fObject.getAttribute('x'), 10);
      targetX += parseInt(fObject.getAttribute('y'), 10); // 计算others相对a.parent位置的坐标

      mindmap_g.selectAll('g.node').filter(function (d, i, n) {
        return !draggedNode.isSameNode(n[i]) && !draggedNode.parentNode.isSameNode(n[i]);
      }).each(function (d, i, n) {
        var gNode = n[i];
        var gRect = gNode.getElementsByTagName('foreignObject')[0];
        var rect = {
    ...
    dragback: function dragback(subject, draggedNode) {
      var draggedNodeChildrenRenew = this.draggedNodeChildrenRenew,
          draggedNodeRenew = this.draggedNodeRenew;
      draggedNodeChildrenRenew(subject, 0, 0);
      draggedNodeRenew(draggedNode, subject.dx, subject.dy, 1000);
    },
    dragended: function dragended(d, i, n) {
      var _this8 = this;

      var dragback = this.dragback,
          root = this.root;
      var subject = on_event.subject;
      var draggedNode = n[i].parentNode;
      var draggedParentNode = draggedNode.parentNode;
      ...
      if (newParentNode) {
        ...
        src_select(draggedNode).each(function (draggedD) {
          src_select(newParentNode).each(function (newParentD) {
            // 处理数据
            draggedNode.remove();

            _this8.del(draggedD.data);

            _this8.add(newParentD.data, draggedD.data);
          });
        });
        return;
      }
      ...
      draggedParentNode = src_select(draggedParentNode);
      draggedParentNode.each(function (d) {
        var draggedBrotherNodes = draggedParentNode.selectAll("g.depth_".concat(d.depth + 1)).filter(function (a, i, n) {
          return !draggedNode.isSameNode(n[i]);
        });
        ...
        if (a.b0 || a.b1) {
          // 存在新兄弟节点时调换节点顺序
          _this8.del(subject.data);

          if (a.b0) {
            // 插入在兄弟节点前面
            _this8.insert(a.b0, subject.data);

            draggedNode.parentNode.insertBefore(draggedNode, a.n0);
          } else if (a.b1) {
            // 插入在兄弟节点后面
            _this8.insert(a.b1, subject.data, 1);
    ...
    // 绘制
    updateMindmap: function updateMindmap() {
      this.tree();
      this.getDTop();
      this.draw();
      this.initNodeEvent();
    },
    gClass: function gClass(d) {
      return "depth_".concat(d.depth, " node");
    },
    gTransform: function gTransform(d) {
      return "translate(".concat(d.dy, ",").concat(d.dx, ")");
    },
    foreignY: function foreignY(d) {
      return -d.data.size[0] / 2 - 5;
    },
    gBtnTransform: function gBtnTransform(d) {
      return "translate(".concat(d.data.size[1] + 8 - this.xSpacing, ",").concat(d.data.size[0] / 2 - 12, ")");
    },
    pathId: function pathId(d) {
      return "path_".concat(d.data.id);
    },
    pathClass: function pathClass(d) {
      return "depth_".concat(d.depth);
    },
    pathColor: function pathColor(d) {
      return d.data.color;
    },
    path: function path(d) {
      return "".concat(this.link({
        source: [(d.parent ? d.parent.y + d.parent.data.size[1] : 0) - d.y - this.xSpacing, // 横坐标
        (d.parent ? d.parent.x + d.parent.data.size[0] / 2 : 0) - d.x // 纵坐标
        ],
        target: [0, d.data.size[0] / 2]
      }), "L").concat(d.data.size[1] - this.xSpacing, ",").concat(d.data.size[0] / 2);
    },
    nest: function nest(d, i, n) {
      var _this9 = this;

      var dd = d.children;

      if (dd) {
        src_select(n[i]).selectAll("g".concat(dd[0] ? ".depth_".concat(dd[0].depth, ".node") : '')).data(dd).join(function (enter) {
          return _this9.appendNode(enter);
        }, function (update) {
          return _this9.updateNode(update);
        }, function (exit) {
          return _this9.exitNode(exit);
        });
      }
    },
    initG: function initG() {
      src_create('g').data();
    },
    appendNode: function appendNode(enter) {
      var gClass = this.gClass,
      ...
      var gNode = enter.append('g');
      gNode.attr('class', gClass).attr('transform', gTransform);
      var foreign = gNode.append('foreignObject').attr('x', -5).attr('y', foreignY);
      ...
      foreignDiv.each(function (d, i, n) {
        var observer = new ResizeObserver(function (l) {
          ...
          var spacing = parseInt(b1, 10) + parseInt(b2, 10);
      ...
      var gBtn = gNode.append('g').attr('class', 'gButton').attr('transform', gBtnTransform);
      ...
      if (enterData.length) {
        if (enterData[0].data.id !== '0') {
          ...
          // 根节点
          foreign.attr('y', function (d) {
            return foreignY(d) + d.size[0] / 2;
          });
        }
    ...
    updateNode: function updateNode(update) {
      var gClass = this.gClass,
          gTransform = this.gTransform,
      ...
      update.each(function (d, i, n) {
        var node = src_select(n[i]);
        var foreign = node.selectAll('foreignObject').filter(function (d, i, n) {
          return n[i].parentNode === node.node();
        }).data(function (d) {
          return [d];
        }) // must rebind the children using selection.data to give them the new data.
        ...
        node.selectAll('g.gButton').filter(function (d, i, n) {
          return n[i].parentNode === node.node();
        }).attr('transform', gBtnTransform(d)).raise();
      });
      return update;
    },
    exitNode: function exitNode(exit) {
    ...
    draw: function draw() {
      ...
      var d = [this.root];
      mindmap_g.selectAll("g".concat(d[0] ? ".depth_".concat(d[0].depth, ".node") : '')).data(d).join(function (enter) {
        return appendNode(enter);
      }, function (update) {
    ...
    tree: function tree() {
      // 数据处理
      var mmdata = this.mmdata,
          ySpacing = this.ySpacing;
      var layout = flextree({
        spacing: ySpacing
      });
      var t = layout.hierarchy(mmdata.data[0]);
      layout(t);
      this.root = t;
    ...
    getTextSize: function getTextSize(t) {
      var dummy = this.dummy,
          xSpacing = this.xSpacing;
      var textWidth = 0;
      var textHeight = 0;
      dummy.selectAll('.dummyText').data([t.name]).enter().append("div").text(function (d) {
        return d;
      }).each(function (d, i, n) {
    ...
    depthTraverse2: function depthTraverse2(d, func) {
      // 深度遍历，func每个元素
      for (var index = 0; index < d.length; index++) {
        var dChild = d[index];
        func(dChild);
    ...
    addWatch: function addWatch() {
      ...
      this.$watch('value', function (newVal) {
        if (_this10.toUpdate) {
          _this10.mmdata = new js_JSONData(newVal);

          _this10.depthTraverse2(_this10.mmdata.data, _this10.getTextSize);
        } else {
          _this10.toUpdate = true;
        }
      }, {
        immediate: true,
        deep: true
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _this11.init(); // this.mindmap_svg.on('mousedown', this.rightDragStart)
              ...
              _context3.next = 4;
              return _this11.makeCenter();

            case 4:
              _context3.next = 6;
              return _this11.fitContent();

            case 6:
              _this11.mindmap_g.style('opacity', 1);
...
// CONCATENATED MODULE: ./src/components/MindMap.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_MindMapvue_type_script_lang_js_ = (MindMapvue_type_script_lang_js_); 
...
var component = normalizeComponent(
  components_MindMapvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var MindMap = (component.exports);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (MindMap);
...
/******/ })["default"];
//# sourceMappingURL=mindmap.common.js.map